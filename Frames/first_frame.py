...
class First_Frame(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.recomm_button = self.create_button(QtCore.QRect(70, 100, 251, 360), font, 'PROPOSE\nCYCLE' , 'propose_button', center_button_style)
        self.my_button = self.create_button(QtCore.QRect(470, 100, 251, 360), font, 'MY\nCYCLE' , 'my_button', center_button_style)
        ...
        header = self.create_label(QtCore.QRect(200, 20, 441, 41), font, 'NEED A RECOMMENDATION ?', 'header')
